...
User.belongsToMany(Game, {through: 'usergame', foreignKey: 'userId', onDelete: 'CASCADE'}); // on delete, cascade
...
User.belongsToMany(Location, {through: 'statuses', foreignKey: 'userId', onDelete: 'CASCADE'}); // on delete, cascade 

Game.belongsTo(User, {foreignKey: 'creatorId', as: 'creator'});

Location.belongsTo(Game);
Game.hasMany(Location, {onDelete: 'CASCADE'}); // on delete, cascade
